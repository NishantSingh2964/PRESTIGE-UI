            ...
            <div className="relative aspect-[4/5] md:aspect-auto md:h-[600px] lg:h-[500px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                    ...
                    >
                        ...
                        <h2 className="text-[20px] md:text-[20px] lg:text-[24px] uppercase tracking-[0.2em] font-light text-white mb-4 md:mb-8 leading-tight">
                            Léo et violette
                        </h2>
                        <div className="text-[11px] md:text-[12px] font-light text-white/95 leading-relaxed tracking-wide space-y-2">
