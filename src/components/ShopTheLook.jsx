        ...
        <section className="py-16 md:py-24 bg-[#EFEFEF]">
            <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-[1.4fr_1fr] gap-6 lg:gap-8 items-start max-w-5xl mx-auto">
                        ...
                        <div className="flex flex-col items-start justify-center gap-0 w-full relative">
                            ...
                            <div className="w-full flex flex-col items-center pt-20">
                                ...
                                <div className="mb-6">
                                    <button className="btn-premium-slide bg-transparent text-black py-3 px-10 text-[10px] uppercase tracking-[0.2em] font-medium">
                                        View Product
                                    </button>
                                </div>
                ...
                <div className="md:hidden space-y-8">
                    ...
                    <button className="w-full btn-premium-slide bg-transparent text-black py-4 px-8 text-[11px] uppercase tracking-[0.15em] font-medium">
                        View Products
                    </button>
                </div>
            </div>
